...
<body>
	...
	<script type="text/javascript">
		...
		var height = (document.documentElement.clientHeight - 230) / 2;
		bodyDivElement.style.marginLeft = width + "px";
		bodyDivElement.style.marginTop = height + "px";
		// 当浏览器窗口大小变动的时候可以随时调整位置
		window.onresize = function() {
			var width = (document.documentElement.clientWidth - 880) / 2;
